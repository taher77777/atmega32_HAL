...
u8 EEPROM_u8ReadDataByte(u16 Copy_u16LocationAddress)
{
	...
	TWI_MasterReadDataByte_withNAck(&Local_u8Data);
...
void EEPROM_voidSendDataPage16Byte(u16 Copy_u16LocationAddress, u8 Copy_u8ArrData16Byte[])
{
	...
	/*Send the data 16byte to the memory location*/
	for(Local_u8Counter=0;Local_u8Counter<PAGE_SIZE_BYTES;Local_u8Counter++)
	{
		TWI_MasterWriteDataByte(Copy_u8ArrData16Byte[Local_u8Counter]);
	}
	/*Send stop condition*/
	TWI_SendStopCondition();
...
void EEPROM_u8ReadDataSEQUENTIAL(u16 Copy_u16LocationAddress,u8 Copy_u8ArrData16Byte[])
{
	...
	/*Get the data from memory*/
	for(Local_u8Counter=0;Local_u8Counter<PAGE_SIZE_BYTES-1;Local_u8Counter++)
		{
		TWI_MasterReadDataByte_withAck(&Copy_u8ArrData16Byte[Local_u8Counter]);
		}
		TWI_MasterReadDataByte_withNAck(&Copy_u8ArrData16Byte[Local_u8Counter]);
